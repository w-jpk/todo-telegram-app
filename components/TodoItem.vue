<template>
  <div
    ...
    <div class="flex items-center gap-4">
      <!-- Checkbox -->
      <button @click.stop="toggleComplete" :class="{
      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="flex items-start gap-2 mb-1">
          <p class="text-base font-medium break-words flex-1" :class="{
          ...
          <!-- Priority Indicator -->
          <div v-if="todo.priority && todo.priority !== 'none'" class="shrink-0"
        ...
        <!-- Description -->
        <p v-if="todo.description" class="text-sm mt-1" :class="{
      ...
      <div class="text-right shrink-0">
        <p v-if="todo.dueDate" class="text-sm font-medium" :class="{
          'text-gray-300 dark:text-gray-600': todo.completed,
